                ...
                <div class="modal-body">
                    ...
                    <div class="navbar-form position-relative" role="search">
                        <div class="form-group">
                            <input id="searchFromNavbar" type="text" name="search" class="form-control" placeholder="Search here...">
                        </div>
                        <button onclick="searchFromNavbar()" class="submit-btn"><i class="pe-7s-search"></i></button>
                    </div>
                </div>
            </div>
        </div>
