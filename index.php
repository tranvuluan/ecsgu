            ...
            <div class="row">
                ...
                <div class="col-lg-auto col-md-auto col-12">
                    <ul class="product-tab-nav nav">
                        <li class="nav-item"><a class="nav-link active" onclick="showAllProduct()" data-bs-toggle="tab" href="#tab-product-all">All</a></li>
                ...
                <div class="col">
                    <div class="tab-content top-borber">
                        <!-- 1st tab start -->
                            <?php 
                                $path = dirname(__FILE__);
                                require_once $path. '/process/load_products.php';
                            ?>
